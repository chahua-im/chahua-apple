        ...
        func bind(_ binding: TimelineRowBinding) {
            ...
            let eligibility = MessageReactionEligibility(
                canReact: !binding.context.isInteractionPreview
                    && MessageActionPolicy(row: row, context: binding.actions.interactionContext)
                        .canReact
    ...
    private final class TimelineReactionButton: UIControl {
        ...
        override init(frame: CGRect) {
            ...
            registerForTraitChanges([UITraitUserInterfaceStyle.self]) {
                (view: TimelineReactionButton, _: UITraitCollection) in
                view.updatePaint()
            }
        }
        ...
        func configure(
            ...
            while avatars.count < avatarCount {
                ...
                if let last = avatars.last {
                    insertSubview(avatar, belowSubview: last)
                } else {
                    addSubview(avatar)
                }
        ...
        private func updatePaint() {
            ...
            if outgoing && isSelected {
                backgroundColor = UIColor(
                    red: 38 / 255, green: 107 / 255, blue: 180 / 255, alpha: 1)
            } else if isSelected {
                backgroundColor = UIColor(
                    red: 64 / 255, green: 135 / 255, blue: 210 / 255, alpha: 1)
            } else if dark {
                backgroundColor = UIColor(red: 30 / 255, green: 32 / 255, blue: 35 / 255, alpha: 1)
            } else {
                backgroundColor = UIColor(
                    red: 215 / 255, green: 216 / 255, blue: 218 / 255, alpha: 1)
            }
